...
//        handler.printDuplicatedVoters();
    ...
    private static void parseFile(String fileName) throws Exception
    {
        ...
        findEqualVoters(doc, xpath);
        fixWorkTimes(doc);
    }

    private static void findEqualVoters(Document doc, XPath xpath) throws Exception
    {
        ...
        for(int i = 0; i < votersCount; i++)
        {
            ...
            XPathExpression xPathExpression = xpath.compile(
                        "/voters/voter/name/text()");

            String devName = (String) xPathExpression.evaluate(doc, XPathConstants.STRING);
...
//            Voter voter = new Voter(name, birthDay);
            Voter voter = new Voter(devName, birthDay);
            Integer count = voterCounts.get(voter);
