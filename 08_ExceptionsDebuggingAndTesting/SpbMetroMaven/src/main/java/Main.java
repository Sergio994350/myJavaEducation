...
public class Main
{
    private static final Logger logSearch = LogManager.getLogger("log-search");
    private static final Logger logErrors = LogManager.getLogger("log-errors");
    private static final Logger logExceptions = LogManager.getLogger("log-exceptions");
    ...
    public static void main(String[] args)
    {
        ...
        for(;;)
        {
            ...
            logSearch.info("Введена станция отправления в поиске: "+ from);
            Station to = takeStation("Введите станцию назначения:");
            logSearch.info("Введена станция назначения в поиске: "+ to);
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            logErrors.info("Станция не найдена: "+ line);
